...
public interface INetThemeConstants {
    ...
    public static String[] THEME_ID_NAME={
    "THEME_GAMEBACK",
    "THEME_TITEL",
    "THEME_DEATH",
    "THEME_PAUSE",
    ...
    "THEME_WHITE_MANA_BIG",
    "THEME_BLACK_MANA_BIG",
    "THEME_RED_MANA_BIG",
    "THEME_GREEN_MANA_BIG",
    "THEME_BLUE_MANA_BIG",
    
    "THEME_WHITE_MANA_SMALL",
    "THEME_BLACK_MANA_SMALL",
    "THEME_RED_MANA_SMALL",
    "THEME_GREEN_MANA_SMALL",
    "THEME_BLUE_MANA_SMALL",
    ...
    "THEME_SHOP",
    "THEME_SICK",
    "THEME_ALL_MANA_SMALL",
    "THEME_ALIVE"
    };
    
    public static String[] THEME_IMAGE_NAME={
    "GameBack.png",
    "Title.png",
    "Dead.png",
    "Pause.png",
