...
public class InetThemeDataPanel extends javax.swing.JPanel {
    private InetThemeData mInetThemeData = new InetThemeData();
    private InetThemeDataPool mInetThemeDataPool;
    private int mClassSetting=0;

    /** Creates new form InetThemeDataPanel */
    public InetThemeDataPanel() {
        initComponents();
    ...
    {
        mClassSetting++;
        Collection<String> collectionKlasse = mInetThemeDataPool.getKlassenHashMap().values();
        ...
        Collection<InetThemeData> colC = mInetThemeDataPool.getMapForKlasse(klasse).values();
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mInetThemeData.mClass);
        jTextFieldKlasse.setText(mInetThemeData.mClass);
    ...
    {
        mInetThemeData.mClass = jTextFieldKlasse.getText();
