...
public class ActionNewDataPanel extends javax.swing.JPanel {
    private ActionNewData mActionNewData = new ActionNewData();
    private ActionNewDataPool mActionNewDataPool;
    private int mClassSetting=0;

    /** Creates new form ActionNewDataPanel */
    public ActionNewDataPanel() {
        initComponents();
        mActionNewDataPool = new ActionNewDataPool();
    ...
    {
        mClassSetting++;
        Collection<String> collectionKlasse = mActionNewDataPool.getKlassenHashMap().values();
        ...
        Collection<ActionNewData> colC = mActionNewDataPool.getMapForKlasse(klasse).values();
        ...
        while (iterC.hasNext())
        {
            ...
            if ((i==0) && (select))
            {
                ...
                mActionNewData = mActionNewDataPool.get(item.mName);
                setAllFromCurrent();
            }
            i++;
        }
    ...
    {
        mClassSetting++;
        mActionNewData = new ActionNewData();
        setAllFromCurrent();
        mClassSetting--;
    }
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mActionNewData.mClass);
        jTextFieldKlasse.setText(mActionNewData.mClass);
        jComboBoxName.setSelectedItem(mActionNewData.mName);
        jTextFieldName.setText(mActionNewData.mName);
    ...
    {
        mActionNewData.mClass = jTextFieldKlasse.getText();
        mActionNewData.mName = jTextFieldName.getText();
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        readAllToCurrent();
        mActionNewDataPool.put(mActionNewData);
        mActionNewDataPool.save();
        mClassSetting++;
    ...
    private void jButtonSaveAsNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveAsNewActionPerformed
        mActionNewData = new ActionNewData();
        readAllToCurrent();
        mActionNewDataPool.putAsNew(mActionNewData);
        mActionNewDataPool.save();
        mClassSetting++;
        String klasse = jTextFieldKlasse.getText();
        resetConfigPool(true,klasse);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        readAllToCurrent();
        mActionNewDataPool.remove(mActionNewData);
        mActionNewDataPool.save();
        mClassSetting++;
        String klasse = jTextFieldKlasse.getText();
        resetConfigPool(true,klasse);
        ...
        mActionNewData = mActionNewDataPool.get(key);
        setAllFromCurrent();
