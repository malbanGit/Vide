...
public class ActionDataPanel extends javax.swing.JPanel {
    private ActionData mActionData = new ActionData();
    private ActionDataPool mActionDataPool;
    private int mClassSetting=0;

    /** Creates new form ActionDataPanel */
    public ActionDataPanel() {
        initComponents();
        mActionDataPool = new ActionDataPool();
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mActionData.mClass);
        jTextFieldKlasse.setText(mActionData.mClass);
        jComboBoxName.setSelectedItem(mActionData.mName);
        jTextFieldName.setText(mActionData.mName);
    ...
    {
        mActionData.mClass = jTextFieldKlasse.getText();
        mActionData.mName = jTextFieldName.getText();
