...
public class GetSVGFilenamePanel extends javax.swing.JPanel {

    /** Creates new form FilePropertiesPanel */
    public GetSVGFilenamePanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Enter name for svg-file:");

        jLabel15.setText("Saving is done to current directory, ");

        jLabel16.setText("\".svg\" fill be appended to given name!");
    ...
    public static String showEnterValueDialog()
    {
        ...
        GetSVGFilenamePanel panel = new GetSVGFilenamePanel();
