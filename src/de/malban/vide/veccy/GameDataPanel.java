...
public class GameDataPanel extends javax.swing.JPanel {
    ...
    /** Creates new form GameDataPanel */
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mGameData.mClass);
        jTextFieldKlasse.setText(mGameData.mClass);
        jComboBoxName.setSelectedItem(mGameData.mName);
        jTextFieldName.setText(mGameData.mName);
    ...
    {
        mGameData.mClass = jTextFieldKlasse.getText();
        mGameData.mName = jTextFieldName.getText();
