...
public class ActionTriggerDataPanel extends javax.swing.JPanel {
    private ActionTriggerData mActionTriggerData = new ActionTriggerData();
    private ActionTriggerDataPool mActionTriggerDataPool;
    private int mClassSetting=0;

    /** Creates new form ActionTriggerDataPanel */
    public ActionTriggerDataPanel() {
        initComponents();
        mActionTriggerDataPool = new ActionTriggerDataPool();
    ...
    {
        mClassSetting++;
        Collection<String> collectionKlasse = mActionTriggerDataPool.getKlassenHashMap().values();
        ...
        Collection<ActionTriggerData> colC = mActionTriggerDataPool.getMapForKlasse(klasse).values();
        ...
        while (iterC.hasNext())
        {
            ...
            if ((i==0) && (select))
            {
                ...
                mActionTriggerData = mActionTriggerDataPool.get(item.mName);
                setAllFromCurrent();
            }
            i++;
        }
    ...
    {
        mClassSetting++;
        mActionTriggerData = new ActionTriggerData();
        setAllFromCurrent();
        mClassSetting--;
    }
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mActionTriggerData.mClass);
        jTextFieldKlasse.setText(mActionTriggerData.mClass);
        jComboBoxName.setSelectedItem(mActionTriggerData.mName);
        jTextFieldName.setText(mActionTriggerData.mName);
    ...
    {
        mActionTriggerData.mClass = jTextFieldKlasse.getText();
        mActionTriggerData.mName = jTextFieldName.getText();
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        readAllToCurrent();
        mActionTriggerDataPool.put(mActionTriggerData);
        mActionTriggerDataPool.save();
        mClassSetting++;
    ...
    private void jButtonSaveAsNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveAsNewActionPerformed
        mActionTriggerData = new ActionTriggerData();
        readAllToCurrent();
        mActionTriggerDataPool.putAsNew(mActionTriggerData);
        mActionTriggerDataPool.save();
        mClassSetting++;
        String klasse = jTextFieldKlasse.getText();
        resetConfigPool(true,klasse);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        readAllToCurrent();
        mActionTriggerDataPool.remove(mActionTriggerData);
        mActionTriggerDataPool.save();
        mClassSetting++;
        String klasse = jTextFieldKlasse.getText();
        resetConfigPool(true,klasse);
        ...
        mActionTriggerData = mActionTriggerDataPool.get(key);
        setAllFromCurrent();
