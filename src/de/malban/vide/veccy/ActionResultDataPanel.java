...
public class ActionResultDataPanel extends javax.swing.JPanel {
    private ActionResultData mActionResultData = new ActionResultData();
    private ActionResultDataPool mActionResultDataPool;
    private int mClassSetting=0;

    /** Creates new form ActionResultDataPanel */
    public ActionResultDataPanel() {
        initComponents();
        mActionResultDataPool = new ActionResultDataPool();
    ...
    {
        mClassSetting++;
        Collection<String> collectionKlasse = mActionResultDataPool.getKlassenHashMap().values();
        ...
        Collection<ActionResultData> colC = mActionResultDataPool.getMapForKlasse(klasse).values();
        ...
        while (iterC.hasNext())
        {
            ...
            if ((i==0) && (select))
            {
                ...
                mActionResultData = mActionResultDataPool.get(item.mName);
                setAllFromCurrent();
            }
            i++;
        }
    ...
    {
        mClassSetting++;
        mActionResultData = new ActionResultData();
        setAllFromCurrent();
        mClassSetting--;
    }
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mActionResultData.mClass);
        jTextFieldKlasse.setText(mActionResultData.mClass);
        jComboBoxName.setSelectedItem(mActionResultData.mName);
        jTextFieldName.setText(mActionResultData.mName);
    ...
    {
        mActionResultData.mClass = jTextFieldKlasse.getText();
        mActionResultData.mName = jTextFieldName.getText();
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        readAllToCurrent();
        mActionResultDataPool.put(mActionResultData);
        mActionResultDataPool.save();
        mClassSetting++;
    ...
    private void jButtonSaveAsNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveAsNewActionPerformed
        mActionResultData = new ActionResultData();
        readAllToCurrent();
        mActionResultDataPool.putAsNew(mActionResultData);
        mActionResultDataPool.save();
        mClassSetting++;
        String klasse = jTextFieldKlasse.getText();
        resetConfigPool(true,klasse);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        readAllToCurrent();
        mActionResultDataPool.remove(mActionResultData);
        mActionResultDataPool.save();
        mClassSetting++;
        String klasse = jTextFieldKlasse.getText();
        resetConfigPool(true,klasse);
        ...
        mActionResultData = mActionResultDataPool.get(key);
        setAllFromCurrent();
