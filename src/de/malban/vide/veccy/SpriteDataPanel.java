...
public class SpriteDataPanel extends javax.swing.JPanel {
    ...
    {
        mClassSetting++;
        jComboBoxKlasse.setSelectedItem(mSpriteData.mClass);
        jTextFieldKlasse.setText(mSpriteData.mClass);
        jComboBoxName.setSelectedItem(mSpriteData.mName);
        jTextFieldName.setText(mSpriteData.mName);
    ...
    {
        mSpriteData.mClass = jTextFieldKlasse.getText();
        mSpriteData.mName = jTextFieldName.getText();
