...
public class OneBreakpointPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabelPause.setFont(new java.awt.Font("Geneva", 2, 11)); // NOI18N
        jLabelPause.setText("P");
        add(jLabelPause);
        jLabelPause.setBounds(395, 77, 10, 15);
        ...
        add(jLabel6);
        jLabel6.setBounds(220, 75, 50, 20);
        ...
        add(jLabel8);
        jLabel8.setBounds(310, 75, 40, 20);
        ...
        jButtonFileSelect11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/malban/vide/images/time_go.png"))); // NOI18N
        jButtonFileSelect11.setToolTipText("Pause");
        ...
        jButtonFileSelect11.setBounds(407, 75, 20, 20);

        jLabel9.setFont(new java.awt.Font("Geneva", 2, 11)); // NOI18N
        jLabel9.setText("name");
        add(jLabel9);
        jLabel9.setBounds(220, 50, 50, 20);
        ...
        jButtonFileSelect12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/malban/vide/images/delete.png"))); // NOI18N
        ...
        add(jButtonFileSelect12);
        jButtonFileSelect12.setBounds(430, 75, 20, 20);

        jLabel7.setFont(new java.awt.Font("Geneva", 2, 11)); // NOI18N
        jLabel7.setText("target");
        add(jLabel7);
        jLabel7.setBounds(2, 4, 80, 15);
    ...
    private void jButtonFileSelect11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFileSelect11ActionPerformed
        ...
        jLabelPause.setVisible(!breakpoint.enabled);
        parent.updateDissi();
