...
public class EnvelopeGenerator implements Serializable{
  ...
  transient protected int /* reg16 */rate_counter;

  transient protected int /* reg16 */rate_period;

  transient protected int /* reg8 */exponential_counter;

  transient protected int /* reg8 */exponential_counter_period;

  transient protected int /* reg8 */envelope_counter;

  transient protected boolean hold_zero;

  transient protected int /* reg4 */attack;

  transient protected int /* reg4 */decay;

  transient protected int /* reg4 */sustain;

  transient protected int /* reg4 */release;

  transient protected int /* reg8 */gate;
   ...
   * the rate periods.
   */
  transient protected static int /* reg16 */rate_counter_period[] = {
   ...
   * been verified by sampling ENV3.
   */
  transient protected static int /* reg8 */sustain_level[] = {
