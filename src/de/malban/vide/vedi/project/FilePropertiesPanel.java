...
public class FilePropertiesPanel extends javax.swing.JPanel {
    ...
    public void setFile(String path)
    {
        ...
        pathFull = p.toString();
        relFull = de.malban.util.Utility.makeVideRelative(pathFull);
        
        pathOnly = p.getParent().toString();
        relOnly  = de.malban.util.Utility.makeVideRelative(pathOnly);
...
//        mFilePropertiesPool = new FilePropertiesPool(relOnly, filenameBaseOnly+"FileProperty.xml");
    ...
    private void initComponents() {
        ...
        jTextFieldParam1.setPreferredSize(new java.awt.Dimension(6, 21));

        jTextFieldParam2.setPreferredSize(new java.awt.Dimension(6, 21));

        jLabel7.setText("Parameter");

        jTextFieldParam3.setPreferredSize(new java.awt.Dimension(6, 21));
        ...
        jButtonAction.setPreferredSize(new java.awt.Dimension(90, 21));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(jButtonPre, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void jButtonActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActionActionPerformed
        ...
        ExecutionDescriptor ed = new ExecutionDescriptor(ED_TYPE_FILE_ACTION, "", filenameOnly, "FilePropertiesPanel",de.malban.util.Utility.makeVideAbsolute(path));
    ...
    private void jButtonPreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPreActionPerformed
        ...
        ExecutionDescriptor ed = new ExecutionDescriptor(ED_TYPE_FILE_PRE, "", filenameOnly, "FilePropertiesPanel", de.malban.util.Utility.makeVideAbsolute(path));
    ...
    private void jButtonPostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPostActionPerformed
        ...
        ExecutionDescriptor ed = new ExecutionDescriptor(ED_TYPE_FILE_POST, "", filenameOnly, "FilePropertiesPanel", de.malban.util.Utility.makeVideAbsolute(path));
