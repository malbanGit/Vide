...
public class GetIDValuePanel extends javax.swing.JPanel {

    /** Creates new form FilePropertiesPanel */
    public GetIDValuePanel() {
        initComponents();
    ...
    private void jTextFieldLinenumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldLinenumberActionPerformed
        id = jTextFieldLinenumber.getText();
    ...
    public static String showEnterValueDialog()
    {
        ...
        GetIDValuePanel panel = new GetIDValuePanel();
        
        ArrayList<JButton> eb= new ArrayList<JButton>();
        ModalInternalFrame modal = new ModalInternalFrame("Label ID:", frame.getRootPane(), frame, panel,null, null , null);
