...
public class Command
{
    ...
    public static final Command[] commands = 
    {
        ...
        new Command(D_CMD_TO_FEVER, "ToFever", "tf", 1,1,"\"ToFever\"\tpush the current active ROM to the development mode of VecFever (only with active configured Vedi window)",""),
    };
