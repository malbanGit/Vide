 ...
 * @author malban
 */
public class MemoryInformationTableModelSmall extends AbstractTableModel
{
    ...
    public static int[] columnWidthSmall1 =    {50       , 50    , 150      , 30        , 100       ,10       ,20,20,20,20,20};
    public static int[] columnWidthSmall2 =    {50       , 50    , 150      , 30        , 100       ,10       ,20,20,20,20,20};
...
//        if (smallMode) return true;
    ...
    {
        if (col >= columnWidthSmall1.length) return 10;
        return columnWidthSmall1[col];
    }
    public int getColWidth2(int col)
    {
        if (col >= columnWidthSmall2.length) return 10;
