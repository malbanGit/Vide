...
__asm(
	".bank page_e7 (BASE=0xe7b5,SIZE=0x004b)\n\t"
	".area .0xe7 (OVR,BANK=page_e7)\n\t"
);

// ---------------------------------------------------------------------------
// 0xE700 - MINESTORM

int __Displ8_xy[0xe7d2-0xe7b5]	__attribute__((section(".0xe7"), used)); // 0xE7B5
int __Displ16_xy				__attribute__((section(".0xe7"), used)); // 0xE7D2
