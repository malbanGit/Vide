// ***************************************************************************
// VECTREX EXECUTIVE RUM ADDRESSES AND C INTERFACE - MIDDLE LAYER C FUNCTIONS
...
__NO_INLINE void _Print_Str_d(volatile const int a, volatile const int b, void* volatile const u); // 0xF37A
...
__NO_INLINE long unsigned int _Rise_Run_Angle(volatile const int a, volatile const int b); // 0xF593
