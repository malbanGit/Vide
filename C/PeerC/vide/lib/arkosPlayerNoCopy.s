...
Vec_Music_Work_End EQU $C84C
CVec_Music_Work     ds 0 
PLY_PSGREGISTERSARRAY ds 0
PLY_PSGREG0         ds    1 
PLY_PSGREG1         ds      1 
PLY_PSGREG2         ds      1 
PLY_PSGREG3         ds       1 
...
PLY_PSGREG11       ds       1 
PLY_PSGREG12       ds       2 
PLY_PSGREGISTERSARRAY_END  ds 0
...
;n = Second Byte needed? Needed when Noise, or Manual frequency, or noise with no sound.
                    ...
                    lda      #%00001001                       ; these are the register mask bits for this sound (or this no sound) 
...
; shift is stored in inverse, 7 - shift
                    ...
                    LSRb     
                    LSRb     
                    ANDb     #%00001110                      ; blend out all other data 
                    clra     
...
; now this is NOT
; efficient, copy all data from CVec_Music_Work to Vec_Music_Work
