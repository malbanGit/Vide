...
; Big thanks go out to Chris Salamon, without his programming docs i'd never have gotten
; this far.
...
start_level:	
		LDA	lives			; If spike has no lives left then
		LBEQ	game_over		; go to the game over routine
...
game_over_loop:
		JSR     Wait_Recal              ; Vectrex BIOS recalibration
                ...
                LDA     #$10                    ; Text position relative Y
                LDB     #-$40                   ; Text position relative X
                JSR     Print_Str_d             ; Vectrex BIOS print routine
		LDA	temp
		ADDA	#1
		STA	temp
