...
;
                    ...
                    ds       SCALE_4,1 
                    ds       POS_4,1 
                    ds       IS_NEW_STARFIELD,1                      ; #noDoubleWarn  
                    end struct 
;
                    code     
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
no_anim_update_db: 
                    ...
                    sta      VIA_t1_cnt_lo                ; to timer t1 (lo= 
                    lda      #$4f                         ; intensity 
                    ldb      BEHAVIOUR+u_offset1,u             ; type byte tells us, if the dragon has been shot once 
                    cmpb     #(dragonBehaviour_half/256)                          ; and we thus can set the brightness 
