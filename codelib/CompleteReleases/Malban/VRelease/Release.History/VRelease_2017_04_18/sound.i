...
;***************************************************************************
;
; if music option is 1 than no music is played
; expects in currentMusic  the pointer to the music piece dw (pattern table), dw (next music)
; expects d0 set
;***************************************************************************
init_ym_sound: 
                    lda      musicOption 
...
playMusicOk: 
                    ...
                    ldu      ,x                           ; load pattern 
init_new_pattern 
                    stu      currentPatternPointer 
                    ldu      ,u                           ; now pointer to actual ym data struct 
                    beq      initNextSong 
                    ldd      -2,u 
...
inc_reg_dsy: 
                    ...
                    stx      currentYLenCount 
                    bne      doneSound_2 
; pattern was finished
                    ldu      currentPatternPointer 
                    leau     2,u                          ; next pattern 
                    bra      init_new_pattern 
...
STREAM_FIRST_THREE_SHORTCUT 
                    tst      musicOption 
                    bne      noChangeAtAllp_f3 
                    GET_BIT  
                    bcc      noChangeAtAllp_f3 
                    GET_BIT  
                    bcc      noChangeAtAllp_f3 
                    GET_BIT  
                    bcc      voice0AmplitudedonePart_f3 
                    lda      #0 
                    GET_BIT_first  
                    rola     
                    GET_BIT_middle  
...
FIRST7              =        $3E 
inGameMusic1: 
                    dw       vtkSong                      ; music to play 
                    dw       inGameMusic1                 ; next music piece 
                    include  "song/track_00_01.asm"
                    include  "song/track_01_20.asm"
                    include  "song/track_02_10.asm"
                    include  "song/track_03_08.asm"
                    include  "song/track_04_08.asm"
                    include  "song/track_05_08.asm"
                    include  "song/track_06_08.asm"
                    include  "song/track_07_08.asm"
                    include  "song/track_08_08.asm"
                    include  "song/track_09_08.asm"
                    include  "song/track_0A_08.asm"
                    include  "song/track_0B_08.asm"
                    include  "song/track_0C_18.asm"
                    include  "song/track_0D_08.asm"
                    include  "song/track_0E_06.asm"
                    include  "song/track_0F_08.asm"
                    include  "song/track_10_08.asm"
                    include  "song/track_11_08.asm"
                    include  "song/track_12_08.asm"
                    include  "song/track_13_14.asm"
                    include  "song/track_14_0C.asm"
                    include  "song/track_15_0C.asm"
                    include  "song/track_16_02.asm"
                    include  "song/track_17_01.asm"
                    include  "song/track_17_02.asm"
                    include  "song/track_17_04.asm"
                    include  "song/track_17_08.asm"
                    include  "song/track_18_02.asm"
                    include  "song/track_19_02.asm"
                    include  "song/track_1A_02.asm"
                    include  "song/track_1B_04.asm"
                    include  "song/track_1C_08.asm"
                    include  "song/track_1D_08.asm"
                    include  "song/track_1E_08.asm"
                    include  "song/track_1F_08.asm"
                    include  "song/track_20_02.asm"
                    include  "song/track_20_04.asm"
