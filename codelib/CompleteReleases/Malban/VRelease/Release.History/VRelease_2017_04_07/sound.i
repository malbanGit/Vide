...
inGameMusic1: 
                    ...
                    include  "song/pattern1.asm"
                    include  "song/pattern2.asm"
                    include  "song/pattern3.asm"
                    include  "song/pattern4.asm"
                    include  "song/pattern5.asm"
                    include  "song/pattern6.asm"
                    include  "song/pattern7.asm"
                    include  "song/pattern8.asm"
                    include  "song/pattern9.asm"
                    include  "song/patternA.asm"
                    include  "song/patternB.asm"
                    include  "song/patternC.asm"
                    include  "song/patternD.asm"
                    include  "song/patternE.asm"
                    include  "song/patternF.asm"
                    include  "song/pattern10.asm"
                    include  "song/pattern11.asm"
                    include  "song/pattern12.asm"
                    include  "song/pattern13.asm"
                    include  "song/pattern14.asm"
                    include  "song/pattern15.asm"
vtkSong 
                    dw       pattern1Data                 ; 00 
                    dw       pattern2Data                 ; 01 
                    dw       pattern3Data                 ; 02 
