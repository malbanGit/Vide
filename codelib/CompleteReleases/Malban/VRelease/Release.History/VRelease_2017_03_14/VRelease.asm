; hey dissi "watch highScoreBlock 5 30"
; hey dissi "watch player_score 5 6"
; hey dissi "watch bcd_buf 5 3"
; hey dissi "watch csa_buf 5 6"
...
highScoreBlock  ds 0
highScoreTable      ds HighScoreEntry * 6 ; 6*5 = 30 byte
 ds 2 ; filler to 32
...
test_highscore
 clr tmp_word
 ldx #player_score
 ldu #highScoreTable +3 ; (3 pointer to bcd score)
testNext_highscore_th:
 ...
 leau 6,u
 inc tmp_byte
 cmpu #highScoreTableEnd-3-2 +6
 bne testNext_highscore_th
 lda #$ff
 rts

; copy all others and than current...
newHighscore:
 pshs u,x ; remember the position, here the new score must be copied to, FROM CSA score
copy_next_nhs: 
 ; copy THIS score one further down
 leax 6,u ; here copy the higher positioned score to
 cmpx #highScoreTableEnd-3-2 +6
 beq now_copy_the_new_score
 ldd ,u++
 std ,x++
 lda ,u+
 sta ,x+
