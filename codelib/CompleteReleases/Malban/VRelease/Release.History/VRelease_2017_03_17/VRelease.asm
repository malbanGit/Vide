...
; shot from bomber
; spwan bonus
; dragon hit first time
; dragon children lose
; bonus captured
; awn hiden X
; spawn of circlers/dragons further out
...
MAX_OBJECTS         =        40                           ; todo determine max possible spawns! 
...
speedAlert_1000
 lda #1
 sta starfield_max
 ldd #((INITIAL_EXPLOSION_MAX/5)*256) + (INITIAL_SCORE_DISPLAY_TIME/5)
 bra speed_loaded
