; at random do spawn a "squad!
;scroll text etwas enger machen siehe schutzhauben vectrex
; different scroll text with scroll text init routine -> faster slower etc

; Absturz schutzhauben vectrex

; Scroll text I und X falsch links


; death scene!
; in demo mode statt score - PRESS BUTTON"

; bonus stars may have different dirtections
; game over display only score if not HS edited ->
; or copy score to buffer againƒ√tmp_word
; or use different buffer for hs edit
; possible bonus ALL STAR if no star athere?
; glitch while star appears?

; demo moe with invincible and "press button"

; ah, das erinnert mich an: beim letzten testbin (das mit Musik) fiel mir auf, dass die Liniensegmente des Schildes nicht mehr verbunden sondern
; deutlich offen sind an den Ecken.
...
;***************************************************************************
                    ...
                    INCLUDE  "TitleStuff.asm"           ; vectrex function includes
hello_world_string: 
                    DB       "VECTREX RELEASE. ORIGINAL GAME BY GIMO GAMES. VECTREX VERSION PROGRAMMED BY MALBAN. MUSIC COMPOSED BY OLLIE. ORIGINAL SERIAL ROUTINES BY ALEX HERBET. ADAPTED SERIAL ROUTINES BY THOMAS SONTOWSKI. RELEASE FITTED SERIAL ROUTINES BY MALBAN. HAVE A NICE GAME.                   ", $80
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
PADDBYTES:          ds       2;+1+80
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
vec4Register: 
