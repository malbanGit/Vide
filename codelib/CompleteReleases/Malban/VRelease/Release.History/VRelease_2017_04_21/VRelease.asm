; each destroyed bonus gives extra point additional extra points
; after 3 6 9 pacman is displayed worm etc
...
do_normal_after_all 
                    ...
                    pulu     d,x,pc                       ; (D = y,x, X = vectorlist, Y = DDRA+Scale) ; do all objects (the circling letters and the starfield) 
check_buttons 
...
scroller3: 
                    db       "ORIGINAL SERIAL ROUTINES BY ALEX HERBERT. ADAPTED SERIAL ROUTINES BY THOMAS SONTOWSKI. RELEASE FITTED SERIAL ROUTINES BY MALBAN.                   ", $80
scroller4: 
                    db       "                GREETINGS GO TO DIVERSE VECTREX PEOPLE ... alex herbert"
                    db       "                THOMAS SONTOWSKI"
                    db       "                KRISTOF TUTS"
                    ...
                    db       "                JUAN MATEOS"
                    db       "                IAN NICHOLSON"
                    db       "                AND MANY OTHERS ... THE ROOM FOR GREETINGS IS NOT ENDLESS.",$80
