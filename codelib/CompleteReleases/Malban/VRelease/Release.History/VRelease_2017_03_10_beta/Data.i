...
HunterList_1:
 ...
 DB +$7E, -$06 ; draw to y, x
 DB -$42, -$09 ; draw to y, x
HunterList_2:
 DW       (MAX_LINE_NUM_A-($03+1))*ONE_LINE_LENGTH 
 DB +$28, -$36 ; draw to y, x
 DB -$5E, +$54 ; draw to y, x
 DB +$78, -$25 ; draw to y, x
 DB -$42, +$07 ; draw to y, x
HunterList_3:
 DW       (MAX_LINE_NUM_A-($03+1))*ONE_LINE_LENGTH 
 DB +$18, -$3F ; draw to y, x
 DB -$44, +$6B ; draw to y, x
 DB +$6B, -$44 ; draw to y, x
 DB -$3F, +$18 ; draw to y, x
HunterList_4:
 DW       (MAX_LINE_NUM_A-($03+1))*ONE_LINE_LENGTH 
 DB +$07, -$42 ; draw to y, x
 DB -$26, +$78 ; draw to y, x
 DB +$55, -$5E ; draw to y, x
 DB -$36, +$28 ; draw to y, x
HunterList_5:
 DW       (MAX_LINE_NUM_A-($03+1))*ONE_LINE_LENGTH 
 DB -$09, -$42 ; draw to y, x
 DB -$06, +$7E ; draw to y, x
 DB +$38, -$71 ; draw to y, x
...
HunterList_8:
 DW       (MAX_LINE_NUM_A-($03+1))*ONE_LINE_LENGTH 
 DB -$36, -$28 ; draw to y, x
 DB +$54, +$5E ; draw to y, x
 DB -$25, -$78 ; draw to y, x
 DB +$07, +$42 ; draw to y, x
HunterList_9:
 DW       (MAX_LINE_NUM_A-($03+1))*ONE_LINE_LENGTH 
 DB -$3F, -$18 ; draw to y, x
...
StarletList_0:
 ...
 DB +$37, -$1E ; draw to y, x
 DB -$03, -$54 ; draw to y, x
 DB -$40, +$34 ; draw to y, x
 DB -$52, -$16 ; draw to y, x
 DB +$1E, +$4E ; draw to y, x
 DB -$2E, +$45 ; draw to y, x
 DB +$54, -$05 ; draw to y, x
 DB +$32, +$43 ; draw to y, x
 DB +$16, -$52 ; draw to y, x
 DB +$50, -$1D ; draw to y, x
 DB -$47, -$2C ; draw to y, x
StarletList_1:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$33, -$24 ; draw to y, x
 DB -$0C, -$53 ; draw to y, x
 DB -$3A, +$3B ; draw to y, x
 DB -$54, -$0D ; draw to y, x
 DB +$27, +$4A ; draw to y, x
 DB -$26, +$4A ; draw to y, x
 DB +$53, -$0E ; draw to y, x
 DB +$39, +$3C ; draw to y, x
 DB +$0D, -$54 ; draw to y, x
 DB +$4C, -$25 ; draw to y, x
 DB -$4C, -$24 ; draw to y, x
StarletList_2:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$2F, -$2A ; draw to y, x
 DB -$16, -$51 ; draw to y, x
 DB -$33, +$41 ; draw to y, x
 DB -$55, -$03 ; draw to y, x
 DB +$2F, +$46 ; draw to y, x
 DB -$1D, +$4D ; draw to y, x
 DB +$51, -$18 ; draw to y, x
 DB +$40, +$36 ; draw to y, x
 DB +$03, -$55 ; draw to y, x
 DB +$47, -$2E ; draw to y, x
 DB -$4F, -$1B ; draw to y, x
StarletList_3:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$2A, -$2F ; draw to y, x
 DB -$1F, -$4E ; draw to y, x
 DB -$2B, +$47 ; draw to y, x
 DB -$55, +$06 ; draw to y, x
 DB +$37, +$40 ; draw to y, x
 DB -$14, +$50 ; draw to y, x
 DB +$4D, -$21 ; draw to y, x
 DB +$46, +$2F ; draw to y, x
 DB -$07, -$55 ; draw to y, x
 DB +$41, -$36 ; draw to y, x
 DB -$51, -$12 ; draw to y, x
StarletList_4:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$24, -$33 ; draw to y, x
 DB -$28, -$4A ; draw to y, x
 DB -$22, +$4B ; draw to y, x
 DB -$53, +$10 ; draw to y, x
 DB +$3D, +$39 ; draw to y, x
 DB -$0B, +$52 ; draw to y, x
 DB +$49, -$29 ; draw to y, x
 DB +$4B, +$26 ; draw to y, x
 DB -$11, -$54 ; draw to y, x
 DB +$3B, -$3D ; draw to y, x
 DB -$53, -$08 ; draw to y, x
StarletList_5:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$1E, -$37 ; draw to y, x
 DB -$30, -$45 ; draw to y, x
 DB -$1A, +$4E ; draw to y, x
 DB -$50, +$1A ; draw to y, x
 DB +$43, +$32 ; draw to y, x
 DB -$01, +$52 ; draw to y, x
 DB +$43, -$31 ; draw to y, x
 DB +$4F, +$1D ; draw to y, x
 DB -$1A, -$51 ; draw to y, x
 DB +$34, -$43 ; draw to y, x
 DB -$54, +$01 ; draw to y, x
StarletList_6:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$18, -$3A ; draw to y, x
 DB -$38, -$3F ; draw to y, x
 DB -$11, +$51 ; draw to y, x
 DB -$4D, +$22 ; draw to y, x
 DB +$49, +$2A ; draw to y, x
 DB +$08, +$52 ; draw to y, x
 DB +$3E, -$39 ; draw to y, x
 DB +$51, +$15 ; draw to y, x
 DB -$23, -$4E ; draw to y, x
 DB +$2B, -$49 ; draw to y, x
 DB -$52, +$0B ; draw to y, x
StarletList_7:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$11, -$3C ; draw to y, x
 DB -$3F, -$39 ; draw to y, x
 DB -$07, +$52 ; draw to y, x
 DB -$49, +$2C ; draw to y, x
 DB +$4D, +$21 ; draw to y, x
 DB +$12, +$51 ; draw to y, x
 DB +$36, -$40 ; draw to y, x
 DB +$53, +$0B ; draw to y, x
 DB -$2B, -$49 ; draw to y, x
 DB +$23, -$4E ; draw to y, x
 DB -$51, +$15 ; draw to y, x
StarletList_8:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$0A, -$3E ; draw to y, x
 DB -$45, -$31 ; draw to y, x
 DB +$03, +$53 ; draw to y, x
 DB -$44, +$33 ; draw to y, x
 DB +$50, +$18 ; draw to y, x
 DB +$1B, +$4F ; draw to y, x
 DB +$2F, -$46 ; draw to y, x
 DB +$54, +$01 ; draw to y, x
 DB -$34, -$43 ; draw to y, x
 DB +$1A, -$51 ; draw to y, x
 DB -$4E, +$1D ; draw to y, x
StarletList_9:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB +$03, -$3F ; draw to y, x
 DB -$4A, -$28 ; draw to y, x
 DB +$0C, +$51 ; draw to y, x
 DB -$3D, +$3B ; draw to y, x
 DB +$52, +$0F ; draw to y, x
 DB +$23, +$4B ; draw to y, x
 DB +$27, -$4B ; draw to y, x
 DB +$53, -$08 ; draw to y, x
 DB -$3A, -$3D ; draw to y, x
 DB +$10, -$54 ; draw to y, x
 DB -$4A, +$26 ; draw to y, x
StarletList_10:
 DW       (MAX_LINE_NUM-($0a+1))*ONE_LINE_LENGTH 
 DB -$04, -$3E ; draw to y, x
 DB -$4E, -$21 ; draw to y, x
 DB +$15, +$50 ; draw to y, x
 DB -$36, +$42 ; draw to y, x
 DB +$53, +$05 ; draw to y, x
 DB +$2C, +$46 ; draw to y, x
 DB +$1E, -$4E ; draw to y, x
 DB +$52, -$12 ; draw to y, x
 DB -$42, -$36 ; draw to y, x
 DB +$07, -$55 ; draw to y, x
 DB -$45, +$2F ; draw to y, x
