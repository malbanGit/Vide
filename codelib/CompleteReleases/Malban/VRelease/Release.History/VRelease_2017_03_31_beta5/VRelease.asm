...
; done: stern > 254
; Pacman
; Explosion useses all of object space
; done: Scroll text I und X falsch links
...
; hey d issi "watch starFieldCounter"
; hey d issi "watch starfield_max"
; hey d issi "watch explosionActiveCounter"
; Sound missing:
; awn hiden X
...
;***************************************************************************
                    INCLUDE  "scrollerCode.asm"           ; 
                    INCLUDE  "TitleStuff.asm"             ; 
                    INCLUDE  "GameOver.asm"             ; s
hello_world_string: 
                    DB       "VECTREX RELEASE. ORIGINAL GAME BY GIMO GAMES. VECTREX VERSION PROGRAMMED BY MALBAN. MUSIC COMPOSED BY VTK. ORIGINAL SERIAL ROUTINES BY ALEX HERBET. ADAPTED SERIAL ROUTINES BY THOMAS SONTOWSKI. RELEASE FITTED SERIAL ROUTINES BY MALBAN. HAVE A NICE GAME.                   ", $80
;***************************************************************************
;***************************************************************************
;***************************************************************************
CURRENT_BANK        =        2 
