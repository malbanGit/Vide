...
;   g�r subs av mMove_to_d i hela, mMove_to_d=jsr FxMoveToD
;
;fixlist
;  coolare bullet for homing shots
;  sv�rare
;    1 extra headtr�ff
;    �ka level every two walkers
;    �ka hitpoints baserat p� levelhi?
;  radar plot base
;  thrust flame
; *highscore visas /10
;
;  activate vid 50.000?
;    har n�tt 93000 i normal game
; --> testa:   har n�tt level 6 i normal game
;  smalare huvud f�r varje round
;  l�gre intensity p� bakre berg
;  walker mer hitpoints
;  kortare v�rld
;  st�rre diff p� shotintensities
;  walker fler shots
;  walker lysande shots
;  sv�rare att tr�ffa head
;
...
;  �ka shipshot speed efter tid, s� att man inte kan �ka ikapp sina egna skott
;  gameover, �ka shipy tills utanf�r sk�rm, gameover
...
;    score f�r headshot
;    score f�r bodyshot
;    blinka weakspot i ryggen, om hit d�da direkt
;  radar
...
; *collision ship �r inte centrerad
; *slide left/right ska bara p�verka viewx, ej shipx
;
;optimize speed
;  mountain och ship ritas i scale $7f
;
;till�t att skepp �ker ovan sk�rmen 32 koords
;  och under 32 koords
;  d� m�ste viewy f�lja
;  drawstars
;  flytta ship,mountains och stj�rnor separat? parallax effekt?
;
;title
;  'ZZAP STRIKES BACK'
;  'PRESS FIRE'
...
;  hittest mod body och huvud, mer s�rbar p� huvud
;    g�r f�rst generellt hittest, sedan p� separat yta
;
;  WalkerWidth
...
;
;  hotspot
;    tr�ffar man denna s� d�r walker direkt
;
;  explode
;    FxTargetWalker index, obs ny emit f�r ej ske innan shatter �r klar
;    s�nk walker l�ngsamt genom att �ka dess y
;
;walker damage
;  inital life 64
...
;
;difficulty
;  zzappace �r 32-0, b�rjar p� 32, minskar 1 vart 16:e sekund
;  zzappace �r 255-0, b�rjar p� 255, shr 1 vart 16:e sekund
;  b�de Pace och PaceMask?
;  alt.
;    �ka pace f�r varje d�dad walker
;    ha en klocka f�r varje behov
;    �terg� till l�ngsamt tempo efter snabbaste
...
;  IncreaseDifficulty()
;    anropa flera ggr f�r att testa
;    ZzapShotDelay
;    inc ZzapLevelNo
;      om mod 8=0
;      InitDifficulty()
;      IncreaseDifficulty() f�r att inte b�rja p� noll
...
;  updatewalkers
;    updatera x med tv� ifall framecounter and (4-bytetabell) �r 0
;
;    lda zzapshotdelay
;    anda loopcounterlow
;    bne skipshots
...
;
;sound
;  "puls" ljud n�r walkers r�r sig
;  �kar i takt med zzapclock
;  zc=zzappace shl 4
;  (loopcounter and (255 shl zc))
;
;draw walker
;  walkervisible-flag
;    d� ritas ej score och radar
;  s�tt upp headrect och baserect
;  shots vs walkers
;    endast om visible
...
;  tr�ff med skepp, drain energy v�nd riktning och velocity
;    ZzapClock ds �kar med 1 varje sekund
;      alt ZzapPace �kar med 1 vart 8:e sekund, stannar p� 8
...
;      emit
;        origin HeadX
;        s�tt wsVelocX i riktning mot skepp
;
;
;base
;  rita stationarypod som base
;  ifall walker n�r pod, gameover
;    s�tt viewx till base, loop med waitcalc, emit planetexplode ljud
;
;score
;  anv�nd samma rutiner som vanliga spelet? eget gamemode?
;
;radar
;  display med radar o score, fadas bort n�r walker �r visible
;
